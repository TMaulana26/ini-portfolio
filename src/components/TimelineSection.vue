  ...
  <section id="about" class="space-y-8 py-4">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="relative pl-6 sm:pl-8 border-l-4 border-black dark:border-white space-y-8 ml-2 py-2">
          <div 
          ...
          >
            ...
            <div class="absolute -left-[35px] sm:-left-[43px] top-1.5 w-6 h-6 rounded-full border-4 border-black dark:border-white bg-neoYellow dark:bg-zinc-800 shadow-neo-hover dark:shadow-neo-dark-hover"></div>
